...
export default function TripSaverPage() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your prepaid travel wallet system. Set goals, track progress, and make your dream trips a reality with
            systematic savings.
          </p>
        </div>
        ...
        <Card className="border-0 shadow-xl rounded-2xl mb-8 overflow-hidden">
          <div className="bg-gradient-to-r from-[#0D9488] to-purple-600 text-white p-8">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-white/80 mb-2">Available Balance</p>
                <h2 className="text-4xl font-bold">${balance.toLocaleString()}</h2>
                <p className="text-white/80 mt-2">Ready for your next adventure</p>
              </div>
