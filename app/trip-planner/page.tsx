  ...
  const generateTripPlan = async () => {
    ...
    setTimeout(() => {
      const mockPlan: TripPlan = {
        ...
        community_recommendations: [
          { name: "Japan Cherry Blossom Tour", members: 8, match_percentage: 95 },
          { name: "Tokyo Food Lovers", members: 15, match_percentage: 87 },
          { name: "Photography Japan", members: 12, match_percentage: 82 },
        ],
      }
